...
| pwd | print name of current directory | pwd the ouput `/home/test` |
...
| htop | needs to installed but better verison of top | htop |
...
There are other networking toold you can use like DNS tools like ( nslookup and dig) or packet capturing tools like (tcpdump or wireshark).
